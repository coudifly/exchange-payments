...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('exchange_payments', '0013_auto_20180323_1502'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='bankdeposits',
            options={'verbose_name': 'Bank deposit', 'verbose_name_plural': 'Bank deposits'},
        ),
        migrations.AlterModelOptions(
            name='companybanks',
            options={'verbose_name': 'Company bank', 'verbose_name_plural': 'Company banks'},
        ),
        migrations.AlterModelOptions(
            name='credentials',
        ...
        migrations.AlterField(
            ...
            name='provider',
            field=models.CharField(choices=[('coinpayments', 'coinpayments'), ('tcoin', 'tcoin'), ('bitgo', 'bitgo'), ('advcash', 'advcash')], max_length=20, verbose_name='Provider'),
        ),
        migrations.AlterField(
            model_name='credentials',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='credentials', to=settings.AUTH_USER_MODEL, verbose_name='User'),
        ),
        migrations.AlterField(
            model_name='currencygateway',
            name='currency',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='gateway', to='exchange_core.Currencies', verbose_name='Currency'),
        ),
        migrations.AlterField(
            model_name='currencygateway',
            name='gateway',
            field=models.CharField(choices=[('coinpayments', 'CoinPayments'), ('tcoin', 'Tcoin'), ('bitgo', 'BitGo'), ('advcash', 'Advcash')], max_length=50, verbose_name='Gateway'),
        ),
    ]
