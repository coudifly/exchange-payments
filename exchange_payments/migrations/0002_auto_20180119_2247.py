# Generated by Django 2.0.1 on 2018-01-19 22:47
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('exchange_payments', '0001_initial'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('range_amount', models.DecimalField(decimal_places=8, default=Decimal('0.00'), max_digits=20)),
                ('credited_amount', models.DecimalField(decimal_places=8, default=Decimal('0.00'), max_digits=20)),
                ('holder_agency', models.CharField(blank=True, max_length=10, null=True)),
                ('holder_account_type', models.CharField(blank=True, choices=[('corrente', 'Corrente'), ('poupanca', 'Poupança')], max_length=20, null=True)),
                ('holder_account_number', models.CharField(blank=True, max_length=20, null=True)),
                ('holder_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='Company Name')),
                ('holder_document', models.CharField(blank=True, max_length=20, null=True, verbose_name='CPF/CNPJ')),
                ('receipt', models.ImageField(blank=True, null=True, upload_to='')),
                ('authentication_code', models.CharField(blank=True, max_length=100, null=True, verbose_name='Company Name')),
                ('status', models.CharField(choices=[('pending', 'pending'), ('deposited', 'deposited'), ('expired', 'expired')], default='pending', max_length=20)),
            ],
            options={
