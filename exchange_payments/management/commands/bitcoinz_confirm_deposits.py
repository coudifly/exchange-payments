...
class Command(BaseCommand):
    help = 'Confirm Bitcoin Z deposits'
        ...
        while True:
            ...
            for tx in txs:
                with transaction.atomic():
                    ...
                    currency = Currencies.objects.get(code=settings.BITCOINZ_CURRENCY_CODE)
                    ...
                    print('Pagando {} para a conta Bitcoin Z do usuario {}'.format(tx['amount'], account.user.username))
